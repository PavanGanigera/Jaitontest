...
(function ($) {
  ...
  (function ($) {
    ...
    $(".mobile_menu_btn").on("click", function () {
      $(".mobile_menu_btn > i").toggleClass("fa-bars fa-xmark");

      // Stop / Allow scrolling when menu opens
    ...
    function handleHeaderMode() {
      ...
      if (isMobile) {
        // MOBILE → Fixed header
        header.removeClass("stricky").addClass("fixed");
      } else {
        // DESKTOP → Sticky header
        header.removeClass("fixed").addClass("stricky");
    ...
    $(window).on("scroll", function () {
      if ($(window).width() > 991 && $(".stricked-menu").length) {
    ...
    /* ===============================
       INIT & RESIZE
    =============================== */
    $(document).ready(handleHeaderMode);
    $(window).on("resize", handleHeaderMode);
