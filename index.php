  ...
  <div class="page_wrapper">
    ...
    <main class="page_content">
      ...
      <section class="it_solution_hero_section">
        ...
        <!-- Background Video -->
        <video class="hero_bg_video" autoplay muted loop playsinline>
        ...
        <div class="container">
          <div class="row d-flex justify-content-center align-items-center ">
            <div class="it_solution_hero_content">
              <div class="hero_text text-center">

                <div class="heading_focus_text mb-0 d-inline-flex align-items-center text-white">
                  <span class="badge bg-secondary text-white p-2" style="background:#816afb !important;">JAITON
                    TECHNOLOGIES</span>
                </div>

                <h1 class="text-white">Empowering Digital Transformation</h1>

                <p class="text-white">
                  Your trusted digital partner for building smart, scalable, and future-ready solutions through Design,
                  AI, IoT, and Cloud driven solutions
                </p>

                <ul class="btns_group unordered_list p-0 justify-content-center">
                  <li>
                    <a class="btn" href="#">
                      <span class="btn_label" data-text="Our Services">Our Services</span>
                      <span class="btn_icon">
                        <i class="fa-solid fa-arrow-up-right"></i>
                      </span>
                    </a>
                  ...
                  <li>
                    <a class="btn btn-outline- bg-light text-dark" href="pricing.html">
              ...
              <div class="about_content">
                <div class="heading_block">
                  <div class="heading_focus_text">
                    Who
                    <span class="badge bg-purple text-white">We Are</span>
                  </div>
                  <h2 class="heading_text">
                    Jaiton Technologies
                  </h2>
                  <p class="heading_description mb-0">
                    Global technology partner committed to helping businesses navigate the digital era with confidence.
                    Built on strong values and deep industry understanding, we focus on long-term partnerships that
                    drive sustainable growth. Our approach blends strategic thinking with innovation to deliver
                    meaningful impact. We believe technology should simplify complexity, build trust, and unlock new
                    possibilities for businesses worldwide
                  </p>
                </div>
                <ul class="btns_group unordered_list p-0 justify-content-start">
                  ...
                  <li>
                    <a class="video_btn" href="https://www.youtube.com/watch?v=7e90gBu4pas">
                      ...
                      <span class="btn_label">Our Process</span>
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="iconbox_block layout_icon_left">
                ...
                <div class="iconbox_content">
                  <h3 class="iconbox_title text-dark"><span class="RRR">R</span>eliable Partner</h3>
                  <p class="mb-0">
                    We build long-term partnerships through trust and dependable delivery.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="iconbox_block layout_icon_left">
                ...
                <div class="iconbox_content">
                  <h3 class="iconbox_title text-dark"><span class="RRR">R</span>esult Driven</h3>
                  <p class="mb-0">
                    We pride ourselves on providing the customer centric service in industry.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="iconbox_block layout_icon_left">
                ...
                <div class="iconbox_content">
                  <h3 class="iconbox_title text-dark"><span class="RRR">R</span>easonable Pricing</h3>
                  <p class="mb-0">
                    We believe in providing best pricing that offers exceptional.
                  </p>
                </div>
              </div>
            </div>
    ...
    ================================================== -->
      ...
      <section class="service_section pt-175 pb-80 bg-light section_decoration xb-hidden">
        <div class="container">
          ...
          <div class="row">
            ...
            <!-- 1. End-to-End Designing -->
            <div class="col-lg-3 col-md-6">
              <div class="service_card service_block_2">
                <div class="service_icon mb-3">
                  <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_3rwasyjy.json"
                    background="transparent" speed="1" style="width:100px;height:100px" loop autoplay>
                  </lottie-player>
                </div>
                <h3>End-to-End Designing</h3>
                <p>User-focused UI/UX designs that elevate brand experience.</p>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service_card service_block_2">
                <div class="service_icon mb-3">
                  <lottie-player src="https://assets3.lottiefiles.com/packages/lf20_qp1q7mct.json"
                    background="transparent" speed="1" style="width:100px;height:100px" loop autoplay>
                  </lottie-player>
                </div>
                <h3>AI & ML Solutions</h3>
                <p>Smart, scalable AI-driven solutions tailored to your needs.</p>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service_card service_block_2">
                <div class="service_icon mb-3">
                  <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_vnikrcia.json"
                    background="transparent" speed="1" style="width:100px;height:100px" loop autoplay>
                  </lottie-player>
                </div>
                <h3>IoT Embedded Systems</h3>
                <p>Hardware-integrated solutions with smart connectivity.</p>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service_card service_block_2">
                ...
                <p>Secure, scalable cloud-driven web & mobile applications.</p>
              </div>
            </div>
              ...
              <ul class="empowering_services unordered_list_block ps-lg-5">
                <li>
                  <div class="iconbox_block layout_icon_left">
                    ...
                    <div class="iconbox_content">
                      <h3 class="iconbox_title_rest">Innovation-Driven</h3>
                      <p class="mb-0">
                        We stay ahead with emerging technologies to deliver solutions that matter.
                      </p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="iconbox_block layout_icon_left">
                    ...
                    <div class="iconbox_content">
                      <h3 class="iconbox_title_rest">End-to-End Solutions</h3>
                      <p class="mb-0">
                        From strategy and design to development and deployment—we handle everything.
                      </p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="iconbox_block layout_icon_left">
                    ...
                    <div class="iconbox_content">
                      <h3 class="iconbox_title_rest">Future-Ready Approach</h3>
                      <p class="mb-0">
                        Our solutions are built to scale, adapt, and evolve with your business.
                      </p>
                    </div>
                  </div>
                </li>
      ...
      <!-- why Jaiton Section - End
        ================================================== -->

      <!-- Process Technology Review Section - Start
        ================================================== -->
      <section class="process_technology_review_section bg-dark section_decoration">
        <div class="container">
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6">
              <div class="heading_block">
                ...
                <h2 class="heading_text text-white mb-0">
      ...
      <!-- Portfolio Section - Start
        ================================================== -->
      <section class="pt-0 about_and_case_section bg-dark"
